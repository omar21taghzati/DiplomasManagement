...
<head>
    ...
    <!-- Bootstrap 5 -->
    <!-- Include Bootstrap CSS (v5.x recommended) -->
    ...
    <nav class="navbar navbar-expand-lg px-3">
        ...
        <div class="collapse navbar-collapse" id="navbarNavDropdown">
            {{-- <ul class="navbar-nav me-auto ms-3">
                ...
                <li class="nav-item"><a class="nav-link" href="{{route('diplomas.statistic')}}">Diploma Statistics</a></li>
                <li class="nav-item"><a class="nav-link" href="{{route('bacs.statistic')}}">Bac Statistics</a></li>
                <li class="nav-item"><a class="nav-link" href="{{ route('logout') }}">Log out</a></li>
            </ul> --}}

            <ul class="navbar-nav me-auto ms-3">
                <li class="nav-item">
                    <a class="nav-link {{ request()->routeIs('diplomas.index') ? 'text-primary fw-bold' : '' }}"
                ...
                <li class="nav-item">
                    <a class="nav-link {{ request()->routeIs('bacs.index') ? 'text-primary fw-bold' : '' }}"
                        href="{{ route('bacs.index') }}">
                        Manage Bac
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link {{ request()->routeIs('diplomas.statistic') ? 'text-primary fw-bold' : '' }}"
                        href="{{ route('diplomas.statistic') }}">
                        Diploma Statistics
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link {{ request()->routeIs('bacs.statistic') ? 'text-primary fw-bold' : '' }}"
                        href="{{ route('bacs.statistic') }}">
                        Bac Statistics
                    </a>
                </li>
                <li class="nav-item">
